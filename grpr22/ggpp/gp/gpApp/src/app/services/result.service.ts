...
export class ResultService {
  ...
  private data = [];
  constructor(public db: AngularFirestore,getres:AngularFirestore, public afs:AngularFirestore,private afuth:AngularFireAuth) {
  ...
  getact() {
    ...
    //   if(user) this.userId=user.uid
    // })
    // const r= this.db.collection("activity", ref => ref.where("uid", "==", this.userId));

    // return r.valueChanges();
// const db=firebase.firestore();

// const d=db.collection('activity').where('uid', '==', id);
// return d;
